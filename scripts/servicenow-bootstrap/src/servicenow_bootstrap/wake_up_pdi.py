...
Automates waking a hibernating ServiceNow developer instance by logging into
the ServiceNow Developer Portal via Playwright and triggering the instance wake-up.
"""
